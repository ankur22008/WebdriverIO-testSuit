exports.config = {
 ...
 //    path: '/wd/hub',
    ...
    capabilities: [
       ...
       browserName: 'chrome',
             chromeOptions: {
      binary: "/var/lib/jenkins/workspace/AnkurTestRun/node_modules/selenium-standalone/.selenium/chromedriver/2.45-x64-chromedriver.exe"
    }
   }
    // 
    //
...
//         }
   ...
   services: ['selenium-standalone'],
    ...
    //
    // Test reporter for stdout.F
    // The only one supported by default is 'dot'
    // see also: http://webdriver.io/guide/reporters/dot.html
    // reporters: ['dot'],//
    // If you are using Cucumber you need to specify the location of your step definitions.
    cucumberOpts: {
        require: ['./features/step-definition/*.js'],        // <string[]> (file/dir) require files before executing features
